...
createProp("sim/an148/mid_subpanel", "int", 1);
createProp("sim/an148/capt_subpanel", "int", 1);
createProp("sim/an148/fo_subpanel", "int", 1);
createProp("sim/an148/central_tunnel_subpanel", "int", 0);
createProp("sim/an148/fctl_subpanel", "int", 0);
createProp("sim/an148/overhead", "int", 0);
